...
'.tm-search-bar{display:none;padding:8px 15px;border-bottom:1px solid var(--tm-border,rgba(127,127,127,.08));background:var(--tm-head-bg,rgba(0,0,0,.06));flex-shrink:0;}',
            ...
            '.tm-badge-on{position:absolute;top:5px;right:5px;width:20px;height:20px;border-radius:50%;background:var(--SmartThemeQuoteColor,#7c6daf);color:var(--tm-accent-text,#fff);display:flex;align-items:center;justify-content:center;font-size:.6em;box-shadow:0 2px 6px var(--tm-shadow,rgba(0,0,0,.3));}',
