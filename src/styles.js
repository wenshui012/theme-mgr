(function (global) {
    ...
    ns.injectStyles = function () {
        ...
        s.textContent = [
            ...
            '.tm-overlay[data-tm-active-page="avatars"] .tm-bottombar{justify-content:space-evenly;gap:0;padding-left:max(0px,env(safe-area-inset-left,0px));padding-right:max(0px,env(safe-area-inset-right,0px));}',
            '.tm-overlay[data-tm-active-page="avatars"] #tm-bottom-settings{margin-left:0;}',
            '.tm-overlay[data-tm-active-page="avatars"] .tm-bottom-btn{width:34px;height:34px;border:0 !important;border-radius:var(--tm-control-radius,50%);background:var(--tm-control-bg,rgba(127,127,127,.08)) !important;box-shadow:none !important;font-size:1.15em;opacity:.68;}',
...
'.tm-sheet-overlay{position:absolute !important;inset:0 !important;z-index:1 !important;background:rgba(0,0,0,.45) !important;pointer-events:auto !important;}',
            '.tm-action-dialog-overlay{display:grid;place-items:center;padding:18px;box-sizing:border-box;}',
            '.tm-action-dialog{width:min(100%,360px);max-height:min(82vh,620px);max-height:min(82dvh,620px);overflow-y:auto;box-sizing:border-box;padding:16px;border:var(--tm-control-border-style,1px solid var(--tm-control-border,rgba(127,127,127,.18)));border-radius:var(--tm-panel-radius,16px);background:var(--tm-bg2,var(--SmartThemeBackgroundColor,#1a1a1e));color:var(--tm-text,var(--SmartThemeBodyColor,#eee));box-shadow:var(--tm-panel-shadow,0 16px 46px rgba(0,0,0,.35));}',
            ...
            '.tm-avatar-unbind-group-title{display:flex;align-items:center;gap:7px;padding:4px 5px 1px;font-size:.78em;font-weight:750;opacity:.72}.tm-avatar-unbind-group-title i{width:18px;text-align:center;color:var(--SmartThemeQuoteColor,#7c6daf)}.tm-avatar-unbind-danger{margin-top:7px;padding-top:9px;border-top:1px solid rgba(127,127,127,.14)}.tm-avatar-unbind-danger .tm-action-dialog-item{background:rgba(229,115,115,.07);border-color:rgba(229,115,115,.3)}',
            ...
            '.tm-field input[type=text],.tm-field input[type=time],.tm-field select,.tm-field textarea{background:var(--tm-control-bg,rgba(127,127,127,.08));border:var(--tm-control-border-style,1px solid var(--tm-control-border,rgba(127,127,127,.2)));border-radius:var(--tm-control-radius,8px);color:inherit;padding:9px 11px;font-size:.9em;width:100%;box-sizing:border-box;font-family:inherit;}',
            ...
            '.tm-day-night-setting-detail[hidden]{display:none!important;}',
            '.tm-day-night-setting-toggle{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;margin:4px 0 10px;}',
            '.tm-day-night-setting-toggle button{padding:9px;border:1px solid rgba(127,127,127,.18);border-radius:8px;background:rgba(127,127,127,.06);color:inherit;font:inherit;cursor:pointer;}',
            '.tm-day-night-setting-toggle button.on{border-color:var(--SmartThemeQuoteColor,#7c6daf);background:color-mix(in srgb,var(--SmartThemeQuoteColor,#7c6daf) 16%,transparent);color:var(--SmartThemeQuoteColor,#7c6daf);font-weight:650;}',
            '.tm-day-night-time-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;}',
            ...
            '.tm-bottom-btn{position:relative;}',
            '.tm-update-dot{position:absolute;top:5px;right:5px;width:8px;height:8px;border-radius:50%;background:#e84d58;box-shadow:0 0 0 2px var(--tm-bg2,var(--SmartThemeBackgroundColor,#1a1a1e)),0 0 7px rgba(232,77,88,.72);pointer-events:none;}',
            '.tm-update-dot[hidden]{display:none !important;}',
            '.tm-update-panel{margin-top:18px;padding:14px;border-top:1px solid rgba(127,127,127,.14);border-radius:12px;background:rgba(127,127,127,.04);}',
            '.tm-settings-sheet .tm-update-panel{margin-top:auto;}',
            '.tm-update-panel.has-update{border-color:rgba(232,77,88,.28);background:rgba(232,77,88,.055);}',
            '.tm-update-panel-head{display:flex;align-items:center;justify-content:space-between;gap:12px;}',
            '.tm-update-panel-head>div{display:flex;min-width:0;flex-direction:column;gap:3px;}',
            '.tm-update-panel-head strong{font-size:.9em;}',
            '.tm-update-status{font-size:.72em;opacity:.58;}',
            '.tm-update-panel.has-update .tm-update-status{color:#e85f69;opacity:1;font-weight:650;}',
            '.tm-update-action{flex:0 0 auto;font-size:.78em;padding:7px 10px;}',
            '.tm-update-detail{margin-top:8px;font-size:.7em;line-height:1.45;opacity:.5;word-break:break-word;}',
            '.tm-plugin-credit{display:flex;flex-wrap:wrap;justify-content:space-between;gap:5px 12px;margin-top:12px;padding-top:10px;border-top:1px solid rgba(127,127,127,.1);font-size:.68em;opacity:.42;}',
            '.tm-update-confirm-copy{display:flex;flex-direction:column;gap:8px;padding:4px 2px 8px;line-height:1.5;}',
            '.tm-update-confirm-copy strong{font-size:.92em;}',
            '.tm-update-confirm-copy p{margin:0;font-size:.78em;opacity:.66;}',
            '.tm-update-confirm-copy small{font-size:.7em;opacity:.48;word-break:break-all;}',
